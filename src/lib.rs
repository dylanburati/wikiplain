...
// bitflags! {
//     struct WikiPageFields: u64 {
//         const ID = 0b00000001;
//         const NS = 0b00000010;
//         const TITLE = 0b00000100;
//         const REDIRECT = 0b00001000;
//         const TIMESTAMP = 0b00010000;
//         const TEXT = 0b00100000;
//         const REQUIRED = Self::ID.bits | Self::NS.bits | Self::TITLE.bits | Self::TIMESTAMP.bits | Self::TEXT.bits;
//         const NONE = 0b0;
//     }
// }
...
fn load_bz2_rs(dump_path: &str, output_path: &str) -> Result<(), Box<dyn Error>> {
...
fn load_bz2(dump_path: &str, output_path: &str) -> PyResult<()> {
    let res =
        load_bz2_rs(dump_path, output_path).map_err(|err| PyValueError::new_err(err.to_string()));
    res
}
